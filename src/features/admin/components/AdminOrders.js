                ...
                {orders.map((order) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-0 text-center">
                      <div className="">
                        <div>
                          <strong>{order.selecteAddress.name}</strong>,
                        </div>
                        <div>{order.selecteAddress.street},</div>
                        <div>{order.selecteAddress.city}, </div>
                        <div>{order.selecteAddress.state}, </div>
                        <div>{order.selecteAddress.pinCode}, </div>
                        <div>{order.selecteAddress.phone}, </div>
                      </div>
                    </td>
                    <td className="py-3 px-0 text-center">
